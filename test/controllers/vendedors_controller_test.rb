...
class VendedorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vendedor" do
    assert_difference("Vendedor.count") do
      post vendedors_url, params: { vendedor: { amount: @vendedor.amount, mail: @vendedor.mail, name: @vendedor.name } }
    end
  ...
  test "should update vendedor" do
    patch vendedor_url(@vendedor), params: { vendedor: { amount: @vendedor.amount, mail: @vendedor.mail, name: @vendedor.name } }
